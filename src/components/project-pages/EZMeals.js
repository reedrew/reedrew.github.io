	...
	return (
		<div className='project-info'>
			...
			<p>
				...
				system from scratch in order to solve some environmental issue.
			</p>
			<p>
				As a team, we settled on the issue of food waste by creating a
				meal-planning tool to encourage college students to effectively plan and
				shop for home cooking. This application allows users search through
				hundreds of recipes, add them to their calendar, and generate grocery
				lists based on their saved recipes. It also allows users to save a
				dietary preference, such as 'vegetarian,' and the application would only
				show recipes that fit that preference.
			</p>
			<p>
				...
				store recipe data as well as database management to store and fetch user
				info.
			</p>
